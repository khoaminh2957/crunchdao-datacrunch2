"""v23: rank + XGB with heavy bagging (smaller subsample + colsample).

v14: subsample=0.8, colsample=0.5 = 0.0497.
v23: subsample=0.6, colsample=0.4 — more bagging diversity, less overfit per tree.
"""
import pandas as pd
import numpy as np
import pickle
