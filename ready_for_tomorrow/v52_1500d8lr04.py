"""v52 R2 STABLE: XGB 1500/d8/lr=0.04 (local CV 0.08238, std 0.0210 — most stable)."""
...
def train(X_train, y_train, model_directory_path):
    ...
    print(f"[v52/train] STABLE: 1500/d8/lr=0.04 on {len(Xt)} rows × {len(feature_cols)} feats")
    model = XGBRegressor(
