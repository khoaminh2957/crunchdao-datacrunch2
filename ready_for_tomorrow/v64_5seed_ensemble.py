"""v64: 5-seed ensemble of v14 config (XGB 500/d6/lr=0.03 RAW).

Local pred: 0.0648 mean (same as single seed), std/sqrt(5)=0.017 (3x less variance).
Predicted cloud: 0.065 ± 0.017 → 1σ range [0.048, 0.082].
"""
...
def train(X_train, y_train, model_directory_path):
    ...
    models = []
    for seed in [42, 7, 2026, 11, 99]:
        print(f"[v64/train] seed={seed}")
        m = XGBRegressor(
