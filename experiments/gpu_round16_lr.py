"""R16: learning_rate × n_estimators tradeoff — slower learning rate often
beats baseline at same total signal capacity.

Tests:
  A. lr=0.01, n=1500 (slower, equiv. n_trees*lr=15)
  B. lr=0.02, n=750  (intermediate)
  C. lr=0.05, n=300  (faster, equiv. capacity)
Baseline: lr=0.03, n=500 (capacity=15).
"""
...
print("=== A. lr=0.01 n=1500 ==="); run('lr01_n1500', 0.01, 1500)
print("=== B. lr=0.02 n=750 ===");  run('lr02_n750',  0.02, 750)
print("=== C. lr=0.05 n=300 ===");  run('lr05_n300',  0.05, 300)
