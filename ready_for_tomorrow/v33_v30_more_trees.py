"""v33: v30 (raw+z-score) with 700 trees lr=0.025 (slightly more capacity).

v30 = 0.0563 (500 trees lr=0.03). v33 tests if marginal more iterations help.
"""
import pandas as pd
import numpy as np
import pickle
...
def train(X_train, y_train, model_directory_path):
    ...
    print(f"[v33/train] fit XGB(700/d6/lr0.025) on {len(Xt)} rows × {len(feature_cols)} feats")
