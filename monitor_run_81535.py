"""Poll run #81535 status every 30s; print transitions."""
...
url = "https://hub.crunchdao.com/competitions/datacrunch-2/models/12867/curly-crayfishwetminh-v2/runs/81535"
...
tab = [t for t in tabs if "runs/81535" in t.get("url","") and t.get("type") == "page"][0]
